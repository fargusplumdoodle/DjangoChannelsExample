...
if _lib.Cryptography_HAS_SSL_ST:
    ...
    __all__.extend(["SSL_ST_INIT", "SSL_ST_BEFORE", "SSL_ST_OK", "SSL_ST_RENEGOTIATE"])
...
_CERTIFICATE_PATH_LOCATIONS = ["/etc/ssl/certs"]  # SLES10/SLES11
...
class _NpnAdvertiseHelper(_CallbackExceptionHelper):
    ...
    def __init__(self, callback):
        ...
        self.callback = _ffi.callback(
            "int (*)(SSL *, const unsigned char **, unsigned int *, void *)", wrapper
        )
...
_requires_npn = _make_requires(_lib.Cryptography_HAS_NEXTPROTONEG, "NPN not available")
